...
- `Gatunki`,
- `Archetypy`,
- `Premie Frakcji` — w polskim interfejsie widoczna jako `Premie z Przeszłości Frakcji`,
...
- `Gatunki`,
- `Archetypy`,
- `Premie Frakcji` — shown in the Polish interface as `Premie z Przeszłości Frakcji`,
- `Słowa Kluczowe Frakcji`,
- `Pakiety Wyniesienia`,
- `Specjalne Bonusy Frakcji`,
- `Implanty Astartes`,
