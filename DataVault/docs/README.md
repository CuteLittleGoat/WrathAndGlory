...
- Checkbox „Czy wyświetlić zakładki dotyczące zasad walki?” ukrywa/pokazuje zakładki **Trafienia Krytyczne**, **Groza Osnowy** i **Skrót Zasad** (te dwie pierwsze są dostępne tylko w trybie admina).
...
- The “Czy wyświetlić zakładki dotyczące zasad walki?” checkbox hides/shows the combat rules tabs (with **Skrót Zasad** for all users and the other two tabs in admin mode only).
