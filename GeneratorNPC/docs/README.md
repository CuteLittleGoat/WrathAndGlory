...
- PL: Okno dostępu do prywatnych danych zawiera ikonę `IkonaPowiadomien2.png` ze stałym miejscem 72×72 px, co stabilizuje rozmiar okna podczas ładowania.
- EN: The private-data access window includes `IkonaPowiadomien2.png` in a fixed 72×72 px slot, keeping dialog size stable during loading.
