...
3. Ustaw **Stopień Trudności** (1-99) — wymagana liczba punktów do sukcesu.
4. Ustaw **Pulę Kości** (1-99) — liczbę kości do rzutu.
5. Ustaw **Ilość Kości Furii** (1-99) — liczba czerwonych kości; nie może być większa niż Pula Kości.
6. Kliknij **Rzuć kośćmi!**
7. W trakcie animacji na kościach pojawia się obracający znak zapytania:
...
3. Set the **Difficulty** (1-99) — required points for success.
4. Set the **Dice Pool** (1-99) — number of dice to roll.
5. Set the **Fury Dice** (1-99) — number of red dice; it cannot exceed the Dice Pool.
6. Click **Rzuć kośćmi!**
7. During the animation a rotating question mark appears on the dice:
